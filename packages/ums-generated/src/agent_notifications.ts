...
export function wrapAgentNotifications<T extends Constructor<INotificationHandler<IAgentNotificationsType, AgentNotifications>>>(Base: T): T & AgentNotificationsWrapperConstructor {
